...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/saveNewThread").hasAnyAuthority(ROLE_USER, ROLE_ADMIN)
                .antMatchers(HttpMethod.POST, "/saveUpdatedThread").hasAnyAuthority(ROLE_USER, ROLE_ADMIN)
                ...
                .antMatchers(HttpMethod.GET, "/jobs/applied").authenticated()
                .antMatchers(HttpMethod.GET, "/jobs/my-job").authenticated()
                .antMatchers(HttpMethod.GET, "/deleteThread").hasAnyAuthority(ROLE_USER, ROLE_ADMIN)
                ...
                .antMatchers(HttpMethod.GET, "/add-education").hasAnyAuthority(ROLE_USER, ROLE_ADMIN)
                .antMatchers(HttpMethod.GET, "/edit-education").hasAnyAuthority(ROLE_USER, ROLE_ADMIN)
                .antMatchers(HttpMethod.POST, "/saveEducation").hasAnyAuthority(ROLE_USER, ROLE_ADMIN)
                .antMatchers(HttpMethod.GET, "/deleteEducation").hasAnyAuthority(ROLE_USER, ROLE_ADMIN)
                .and()
                .logout()
